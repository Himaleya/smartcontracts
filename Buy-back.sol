...
pragma solidity ^0.4.11;
	...
	*/
	...
	contract EXP24KBuyback is Guarded, Ownable {
	
	using SafeMath for uint256;
	
	mapping(address => uint256) redeemers; // contributions from EXP24K holders
	...
	/**
	* Okay, we changed the process flow a bit where the actual EXP24K to ETH
	...
	*/
	...
	uint256 totalEXP24KRedeemed = weiRedeemed.add(msg.value);
	bool withinCap = totalEXP24KRedeemed <= totalRedeemCap;
